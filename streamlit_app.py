...
def app():
    ...
    st.write('Glass recognition: Recognizing the different types of things that made up of glass.')
    st.write("""Simple image classification: Classifying simple images into categories: Mug, Wine Glass, Test tube and Beaker.""")
